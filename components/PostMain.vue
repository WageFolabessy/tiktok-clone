<template>
    <div id="PostMain" class="flex border-b py-6">
        ...
        <div class="pl-3 w-full px-4">
            ...
            <div class="text-[15px] pb-0.5 break-words md:max-w-[400px] max-w-[300px]">text post</div>
            <div class="flex items-center ">
                <div class="px-1 text-blue-500 pb-0.5 font-semibold cursor-pointer hover:underline">#fun</div>
                <div class="px-1 text-blue-500 pb-0.5 font-semibold cursor-pointer hover:underline">#awesome</div>
            </div>
            <div class="text-[14px] pb-0.5 flex items-center font-semibold">
                <Icon name="mdi:music" size="17"/>
                <div class="px-1 cursor-pointer hover:underline">suara asli - AWESOME</div>
