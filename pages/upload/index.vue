<template>
    ...
    <UploadLayout>
        <div class="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
            <div>
                <div class="text-[23px] font-semibold">Unggah video</div>
                <div class="text-gray-400 mt-1">Posting video ke akun anda</div>
            </div>
            <div class="mt-8 md:flex gap-6">
                ...
                >
                    ...
                    <div class="mt-4 text-[17px]">Pilih video untuk diunggah</div>
                    <div class="mt-1.5 text-gray-500 text-[13px]">Atau seret dan lepas video disini</div>
                    <div class="mt-12 text-gray-400 text-sm">MP4</div>
                    <div class="mt-2 text-gray-400 text-[13px]">Maksimal 30 minutes</div>
                    <div class="mt-2 text-gray-400 text-[13px]">Kurang dari 2 GB</div>
                ...
                <div class="mt-4 mb-6">
                    <div class="flex bg-[#F8F8F8] py-4 px-6">
                        ...
                        <div>
                            <div class="text-semibold text-[15px] mb-1.5">Edit video</div>
